...
import { formatTime, extractAudioFromVideo, captureVideoFrame, getBestAudioFormat, type ExportFormat } from "@/lib/videoEngine";

export function VideoAudioThumbnail() {
    ...
    <div className="grid lg:grid-cols-[1fr_340px] gap-6 items-start">
      <div className="space-y-4">
        {!meta ? (
          ...
          <>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 p-5 shadow-sm space-y-4">
              <p className="text-sm font-bold text-slate-700 dark:text-slate-200">Ambil Thumbnail</p>
              ...
              <Btn onClick={runCaptureThumbnail} disabled={isCapturing} variant="secondary" className="w-full gap-2">
      ...
      <div className="space-y-4 lg:sticky lg:top-24">
        ...
        <ToolInfoPanel
          ...
          label="Ekstrak Audio & Thumbnail"
          desc="Ambil suara atau gambar dari video"
          points={[
