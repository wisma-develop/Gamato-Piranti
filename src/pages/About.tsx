...
const toolSuite = [
  ...
  { icon: <AudioLines className="w-5 h-5" />, label: 'Audio Studio', desc: 'Speech to text, text to speech, pengukur kekuatan suara real-time, dan ekstrak audio dari file video — semua langsung dari browser.' },
